    ...
    <div className="app-container">
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .tbl-gider th:nth-child(2), .tbl-gider td:nth-child(2) { width: 30%; }
        .tbl-gider th:nth-child(3), .tbl-gider td:nth-child(3) { width: 16%; }
        .tbl-gider th:nth-child(4), .tbl-gider td:nth-child(4) { width: 20%; }
        ...
        @media (max-width: 600px) {
          ...
          .tbl-gider th:nth-child(2), .tbl-gider td:nth-child(2) { width: 28% !important; font-size: 10px !important; }
          .tbl-gider th:nth-child(3), .tbl-gider td:nth-child(3) { width: 16% !important; font-size: 10px !important; }
          .tbl-gider th:nth-child(4), .tbl-gider td:nth-child(4) { width: 23% !important; font-size: 10px !important; }
